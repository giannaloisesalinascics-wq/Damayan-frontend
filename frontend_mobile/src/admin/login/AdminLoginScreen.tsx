...
export function AdminLoginScreen({
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (result.user.role !== AppRole.ADMIN) {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.citizenShell}>
          ...
          <View style={styles.editorialPanel}>
            <Text style={[styles.gatewayLabel, { color: accent }]}>SYSTEM COMMAND CENTER</Text>
            <Text style={styles.editorialTitle}>
              Platform{"\n"}
              <Text style={[styles.editorialAccent, { color: accent }]}>Governance</Text>
            </Text>
            <Text style={styles.editorialText}>
              System-wide monitoring, administrative overrides, and multi-sector platform reporting dashboard.
            </Text>
          ...
          <View style={styles.loginCard}>
            <View style={styles.loginIntro}>
              ...
              <Text style={styles.loginSubtitle}>
                Authenticate your credentials to enter the admin dashboard.
              </Text>
            </View>
