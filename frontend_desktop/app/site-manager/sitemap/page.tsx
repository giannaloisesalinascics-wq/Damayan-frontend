...
export default function SiteManagerSiteMapPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#fafaf5] dark:bg-[#1a1c19] flex items-center justify-center font-bold">Loading Site Map...</div>}>
      <SiteMapContent />
    </Suspense>
  );
}
